        ...
        <section id="rates">
            <Container>
                ...
                <Row>
                    ...
                    <Col lg={4}>
                        <div className="loan-boxs">
                            <div className="box mt-5 lg-mx-4 xl-mx-4">
                ...
                <Row>
                    <Col lg={12}>
                        <p className="rate-disc">
                            All mortgage rates displayed are provided by Zillow based on borrowers
                            with credit scores between 680-740 and represent averages and trends.
                            Please consult with Strategic Financial to receive a personalized rate
